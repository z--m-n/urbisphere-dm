...
<figure><img width="70%" src="assets/Screenshot_api-map.png" title="Example Map"><img src="assets/Screenshot_api-map-menu.png" width="25%" alt="Example Map Menu"><figcaption>Figure: API output</figcaption></figure>
